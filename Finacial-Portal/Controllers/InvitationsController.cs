...
namespace Finacial_Portal.Controllers
{
    public class InvitationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,Accepted,Code,Created,Expires,Email")] Invitation invitation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,Accepted,Code,Created,Expires,Email")] Invitation invitation)
        {
            if (ModelState.IsValid)
            {
